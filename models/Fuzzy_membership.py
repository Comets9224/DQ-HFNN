...
def gaussian_membership(x, mean, std):
    """
    Calculate the Gaussian membership degree of given input x relative to mean and standard deviation std
    """
    return torch.exp(-((x - mean) ** 2) / (2 * std ** 2))


# # Instantiate the layer, each input element has 3 membership functions
